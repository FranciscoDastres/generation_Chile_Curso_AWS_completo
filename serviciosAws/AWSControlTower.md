...
* Que es ? 
# servicio para configurar y gobernar un enterono multi cuenta de AWS siguiente las mejores practicas desde le dia 1        
# es el setup + gobierno de AWS organizations
...
* cuando usarlo
# tienes o tendras muchas cuentas
# quieres seguridad y compilance
# necesitas gobernanza centralizada
# estas empezando un entorno empresarial

* ejemplo tipico de examen
# empresa quiere una forma rapida y segurida de administrar multiples cuentas de AWS
